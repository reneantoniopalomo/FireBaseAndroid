        ...
        btnSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(email)) {
                    Toast.makeText(getApplicationContext(), "Indroduzca la dirección de correo electrónico!", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (password.length() < 6) {
                    Toast.makeText(getApplicationContext(), "Contaseña demasiado corta, ingrese un mínimo de 6 caracteres!", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                auth.createUserWithEmailAndPassword(email, password)
                        .addOnCompleteListener(SignupActivity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                //se notificará al oyente del estado de autenticación y se le asignará una lógica para manejar
